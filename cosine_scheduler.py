...
class CosineLRWithRestarts():
    ...
    def __init__(self, optimizer: Any, batch_size: int, epoch_size: int,
                 restart_period: float = 100, t_mult: float = 2, last_epoch: int = -1,
                 eta_threshold: int = 1000, verbose: bool = False, min_lr: float = 1e-7) -> None:
    ...
    def get_lr(self, t_cur: int) -> Iterator[Tuple[Any, Any]]:
